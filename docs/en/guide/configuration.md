...
| `publications.yaml` | Publication list (the Cite dialog and Highwire meta tags are generated from it); an entry's `thumbnail: assets/…` is the image shown beside it in the home page's `publication-list` block | you |
